...
/*6. Изменение значений в полях «Дата заказа» и «Дата выполнения заказа» таблицы «Заказы», 2022 год на 2024 */
update `Заказы` 
...
/* 9. */
select З.`№ заказа`, `Адрес доставки`, `Дата заказа`, `Дата выполнения заказа`, К.`ISBN`, `Название книги`, `Цена`
